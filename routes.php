...
// Definición de rutas
$routes = [
    '/proyecto/' => 'home',           // Ruta principal que apunta al controlador 'home'
    '/proyecto/about' => 'about',
    '/proyecto/practicas'=> 'practicas',     // Ruta '/about' que apunta al controlador 'about'
];
